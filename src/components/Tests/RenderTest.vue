<template>
   <div class="display-print markdown-body" id="printableElement">
      ...
      <div v-for="(questions, index) in tests" class="page-break" :key="index">
         ...
         <div v-if="type === 1" class="mb-8">
            <div class="information-container mb-2">
               ...
               <p>Numéro étudiant : <span
                 class="text-gray-600 text-xs">...............................................</span></p>
            </div>
            <p>Prénom : <span class="text-gray-600 text-xs">...................................................</span>
            </p>
         </div>
         ...
         <div v-else-if="type === 2" class="mb-8">
            <div class="flex">
               <div class="anonymous-information-container">
                  ...
                  <p>Date de l'Épreuve : <span v-for="index in 300" :key="index" class="text-gray-600 text-sm">.</span>
                  </p>
                  <p>Mention : <span v-for="index in 300" :key="index" class="text-gray-600 text-sm">.</span></p>
                  <p>Numéro Étudiant : <span v-for="index in 300" :key="index" class="text-gray-600 text-sm">.</span>
                  </p>
...
export default {
   ...
   props: { title: String, tests: Object, type: Number },
   data: function() {
      return {
         html: []
      };
