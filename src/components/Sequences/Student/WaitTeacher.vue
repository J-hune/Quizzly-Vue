<template>
   ...
   <div class="px-7 md:px-16 pt-10 w-full">
      ...
      <div class="mt-12">
         ...
         <p>Veuillez patienter quelques instants, vous serez automatiquement redirigé(e) vers la séquence <strong>dès
            que le professeur aura commencé la session.</strong></p>
         <br>
