                        ...
                        <form @submit.prevent="registerUser">
                           ...
                           <div class="flex items-center justify-between pb-6">
                              <p class="mb-0 mr-2">
                                 ...
                                 <router-link class="text-blue-500" to="/signin">Connectez vous !</router-link>
                              </p>
                           </div>
                        </form>
                     </div>
...
import { registerUser } from "@/functions/login";
      ...
      registerUser() {
         ...
         registerUser(userData, data => {
            if (data.success) {
               ...
               this.toast.error("Erreur durant l'enregistrement");
            }
         });
      }
   }
